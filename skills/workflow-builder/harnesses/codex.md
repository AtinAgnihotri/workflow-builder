...
Use `skills/workflow-builder/SKILL.md` as the skill entrypoint. For implementation
inside this repository, also read `README.md`, `docs/`, and `PRPs/`.

Recommended prompt:

```text
Use the Workflow Builder skill. Read skills/workflow-builder/SKILL.md and the
